...
Rectangle {
    ...
    /* 未选中筛选按钮的柔和背景色 */
    readonly property color mutedPanelColor: Qt.rgba(palette.windowText.r, palette.windowText.g, palette.windowText.b, 0.06)
    ...
    /* 状态色的半透明变体（徽章底色） */
    function levelAlpha(color, alpha) {
    ...
    ColumnLayout {
        ...
        // 日志筛选工具栏（Card 位于 dde/components/，经 QtEasyTier 导入解析）
        Card {
            Layout.fillWidth: true
            ...
            RowLayout {
                ...
                // 级别筛选按钮组：全部/信息/警告/错误（自绘彩色胶囊）
                Repeater {
                    model: [
                        { label: qsTr("全部"), level: "all", color: palette.windowText },
                    ...
                    delegate: Rectangle {
                        ...
                        radius: height / 2
                        color: selected ? root.levelAlpha(modelData.color, 0.2) : root.mutedPanelColor
                    ...
                    delegate: ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                radius: height / 2
                                color: root.levelAlpha(root.levelColor(level), 0.16)
